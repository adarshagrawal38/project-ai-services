...
const docTemplate = `{
    ...
    "definitions": {
        ...
        "github_com_project-ai-services_ai-services_internal_pkg_catalog_types.ApplicationPSResponse": {
            ...
            "properties": {
                "components": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github_com_project-ai-services_ai-services_internal_pkg_catalog_types.PodDetails"
                    }
                },
                "id": {
                    "type": "string"
        ...
        "github_com_project-ai-services_ai-services_internal_pkg_catalog_types.PodDetails": {
            "type": "object",
            "properties": {
                "containers": {
                    "type": "array",
